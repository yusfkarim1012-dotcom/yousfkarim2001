          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                SizedBox(height: 8.h),
                Text(_t({
                  'ar': '١. أمسك الهاتف بشكل مسطح.\n٢. أدر جسمك حتى يشير سهم القبلة إلى أعلى شاشة الهاتف تماماً.\n٣. حينها سيكون الاتجاه الذي يواجهه هاتفك هو القبلة الصحيحة.\n(ملاحظة: لا حاجة لمحاذاة السهم مع حرف N أو S، فقط اجعله يشير للأعلى).',
                  'en': '1. Hold your phone flat horizontally.\n2. Turn your body until the Qibla needle points straight to the top of your screen.\n3. The direction your phone is now facing is the correct Qibla.\n(Note: You do not need to align the needle with N or S).',
                  'de': '1. Telefon flach halten.\n2. Drehen Sie sich, bis die Qibla-Nadel zur Spitze des Bildschirms zeigt.\n3. Die Richtung Ihres Telefons ist nun die Qibla.\n(Hinweis: Nadel muss nicht auf N oder S ausgerichtet werden).',
                  'am': '1. ስልኩን ጠፍጣፋ አድርገው ያዙ።\n2. የቂብላ ቀስት ወደ ማያ ገጹ አናት እስኪጠቁም ድረስ ዙሩ።\n3. የስልኮ አቅጣጫ አሁን ቂብላ ነው።\n(ማስታወሻ፡ ከ N ወይም S ጋር ማስተካከል አያስፈልግም)።',
                  'ms': '1. Pegang telefon secara mendatar.\n2. Pusing sehingga jarum Kiblat menunjuk ke bahagian atas skrin.\n3. Arah telefon anda kini adalah Kiblat.\n(Nota: Tidak perlu selaraskan dengan N atau S).',
                  'pt': '1. Segure o telefone plano.\n2. Gire até a agulha da Qibla apontar para o topo da tela.\n3. A direção do seu telefone agora é a Qibla.\n(Nota: Não alinhe com N ou S, apenas para cima).',
                  'tr': '1. Telefonu düz tutun.\n2. Kıble iğnesi ekranın en üstüne bakana kadar dönün.\n3. Telefonunuzun yönü artık Kıble.\n(Not: İğneyi N veya S ile hizalamanıza gerek yoktur).',
                  'ru': '1. Держите телефон горизонтально.\n2. Поворачивайтесь, пока стрелка Киблы не укажет на верх экрана.\n3. Направление вашего телефона теперь Кибла.\n(Прим: Не нужно выравнивать стрелку по N или S).',
                  'ku': '١. مۆبایلەکەت بە ڕووکاری تەخت (ئاسۆیی) ڕابگرە.\n٢. خۆت بسوڕێنە تا سەهمی قیبلە (ئاراستەی کەعبە) ڕێک ڕووی لە سەرەوەی شاشەی مۆبایلەکەت دەبێت.\n٣. لەم کاتەدا، ئەو ئاراستەیەی مۆبایلەکەت ڕووی تێکردووە قیبلەی دروستە.\n(تێبینی: پێویست ناکات سەهمەکە لەگەڵ پیتی N یان S ڕێک بخەیت، تەنها با ڕووی لە سەرەوە بێت).',
                  'ckb': '١. مۆبایلەکەت بە ڕووکاری تەخت (ئاسۆیی) ڕابگرە.\n٢. خۆت بسوڕێنە تا سەهمی قیبلە (ئاراستەی کەعبە) ڕێک ڕووی لە سەرەوەی شاشەی مۆبایلەکەت دەبێت.\n٣. لەم کاتەدا، ئەو ئاراستەیەی مۆبایلەکەت ڕووی تێکردووە قیبلەی دروستە.\n(تێبینی: پێویست ناکات سەهمەکە لەگەڵ پیتی N یان S ڕێک بخەیت، تەنها با ڕووی لە سەرەوە بێت).',
                }),
